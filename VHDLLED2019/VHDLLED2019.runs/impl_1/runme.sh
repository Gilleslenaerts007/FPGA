...
HD_PWD='C:/FPGA/VHDLLED2019/VHDLLED2019.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log loopLicht.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source loopLicht.tcl -notrace
