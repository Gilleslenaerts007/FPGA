...
HD_PWD='C:/FPGA/VHDLLED2019/VHDLLED2019.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log loopLicht.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source loopLicht.tcl
