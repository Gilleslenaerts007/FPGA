...
""" 0. construct mesh """
mesh_obj, el_pos = mesh.create(8, h0=0.1)
...
anomaly = [{'x': 0.1,  'y': 0.2, 'd': 0.4, 'perm': 20}]
...
el_dist, step = 1, 1
ex_mat1 = eit_scan_lines(1, 2)
ex_mat2 = eit_scan_lines(2, 3)
ex_mat3 = eit_scan_lines(3, 4)
ex_mat4 = eit_scan_lines(4, 5)
ex_mat5 = eit_scan_lines(5, 6)
ex_mat6 = eit_scan_lines(6, 7)
ex_mat7 = eit_scan_lines(7, 8)
ex_mat8 = eit_scan_lines(8, 1)
ex_mat = np.vstack([ex_mat1, ex_mat2, ex_mat3, ex_mat4, ex_mat5, ex_mat6, ex_mat7, ex_mat8])
