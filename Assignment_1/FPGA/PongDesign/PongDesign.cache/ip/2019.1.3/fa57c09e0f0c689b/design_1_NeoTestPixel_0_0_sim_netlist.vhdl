...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NeoPixel is
  ...
  signal \delay_low_cntr[3]_i_3_n_0\ : STD_LOGIC;
  signal \delay_low_cntr[3]_i_4_n_0\ : STD_LOGIC;
  signal \delay_low_cntr[3]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \delay_low_cntr_reg[3]_i_1_n_0\ : STD_LOGIC;
  signal \delay_low_cntr_reg[3]_i_1_n_1\ : STD_LOGIC;
  signal \delay_low_cntr_reg[3]_i_1_n_2\ : STD_LOGIC;
  signal \delay_low_cntr_reg[3]_i_1_n_3\ : STD_LOGIC;
...
\delay_low_cntr[3]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_low_cntr[3]_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_low_cntr[3]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_low_cntr[3]_i_5\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_low_cntr_reg[3]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\delay_low_cntr_reg[3]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \delay_low_cntr_reg[3]_i_1_n_0\,
      CO(2) => \delay_low_cntr_reg[3]_i_1_n_1\,
      CO(1) => \delay_low_cntr_reg[3]_i_1_n_2\,
      CO(0) => \delay_low_cntr_reg[3]_i_1_n_3\,
      CYINIT => delay_low_cntr(0),
      DI(3 downto 0) => delay_low_cntr(4 downto 1),
      O(3 downto 0) => delay_low_cntr0(4 downto 1),
      S(3) => \delay_low_cntr[3]_i_2_n_0\,
      S(2) => \delay_low_cntr[3]_i_3_n_0\,
      S(1) => \delay_low_cntr[3]_i_4_n_0\,
      S(0) => \delay_low_cntr[3]_i_5_n_0\
    );
