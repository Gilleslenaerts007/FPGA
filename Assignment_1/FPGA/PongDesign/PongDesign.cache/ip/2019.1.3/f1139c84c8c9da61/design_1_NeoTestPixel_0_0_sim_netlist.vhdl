...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NeoPixel is
  ...
  signal \bit_cntr_reg[0]_i_3_n_0\ : STD_LOGIC;
  signal \bit_cntr_reg[0]_i_3_n_1\ : STD_LOGIC;
  signal \bit_cntr_reg[0]_i_3_n_2\ : STD_LOGIC;
  signal \bit_cntr_reg[0]_i_3_n_3\ : STD_LOGIC;
  signal \bit_cntr_reg[0]_i_3_n_4\ : STD_LOGIC;
  signal \bit_cntr_reg[0]_i_3_n_5\ : STD_LOGIC;
  signal \bit_cntr_reg[0]_i_3_n_6\ : STD_LOGIC;
  signal \bit_cntr_reg[0]_i_3_n_7\ : STD_LOGIC;
  ...
  signal \NLW_delay_high_cntr_reg[5]_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute SOFT_HLUTNM of \delay_low_cntr[10]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \delay_low_cntr[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \delay_low_cntr[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \delay_low_cntr[3]_i_1\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \delay_low_cntr[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \delay_low_cntr[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \delay_low_cntr[8]_i_1\ : label is "soft_lutpair3";
...
begin
  d_out <= \^d_out\;
\GRB[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
...
\GRB[16]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => index_reg_rep(2),
      I3 => index_reg_rep(0),
      I4 => \bit_cntr[0]_i_1_n_0\,
      I5 => GRB(16),
      O => \GRB[16]_i_1_n_0\
    );
\GRB[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FEBEFFFFFEBE0000"
    )
        port map (
      I0 => index_reg_rep(3),
      I1 => index_reg_rep(2),
...
\bit_cntr[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\bit_cntr[0]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\bit_cntr_reg[0]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \bit_cntr_reg[0]_i_3_n_0\,
      CO(2) => \bit_cntr_reg[0]_i_3_n_1\,
      CO(1) => \bit_cntr_reg[0]_i_3_n_2\,
      CO(0) => \bit_cntr_reg[0]_i_3_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"1111",
      O(3) => \bit_cntr_reg[0]_i_3_n_4\,
      O(2) => \bit_cntr_reg[0]_i_3_n_5\,
      O(1) => \bit_cntr_reg[0]_i_3_n_6\,
      O(0) => \bit_cntr_reg[0]_i_3_n_7\,
      S(3) => \bit_cntr[0]_i_4_n_0\,
      S(2) => \bit_cntr[0]_i_5_n_0\,
      S(1) => \bit_cntr[0]_i_6_n_0\,
      S(0) => \bit_cntr[0]_i_7_n_0\
    );
...
\delay_high_cntr_reg[5]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      O(1 downto 0) => \NLW_delay_high_cntr_reg[5]_i_3_O_UNCONNECTED\(1 downto 0),
      S(3) => \delay_high_cntr[5]_i_4_n_0\,
      S(2) => \delay_high_cntr[5]_i_5_n_0\,
      S(1) => \delay_high_cntr[5]_i_6_n_0\,
      S(0) => \delay_high_cntr[5]_i_7_n_0\
    );
...
\delay_low_cntr[10]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\delay_low_cntr[10]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8B"
    )
        port map (
