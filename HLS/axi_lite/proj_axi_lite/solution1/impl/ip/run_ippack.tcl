...
set Interfaces {
    s_axi_BUS_A {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 a W 0x0 "Data signal of a" {{0 8 a W 0 "Bit 7 to 0 Data signal of a"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 b W 0x0 "Data signal of b" {{0 8 b W 0 "Bit 7 to 0 Data signal of b"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 c_i W 0x0 "Data signal of c_i" {{0 8 c_i W 0 "Bit 7 to 0 Data signal of c_i"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 c_o R 0x0 "Data signal of c_o" {{0 8 c_o R 0 "Bit 7 to 0 Data signal of c_o"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x2c c_o_ctrl R 0x0 "Control signal of c_o" {{0 1 c_o_ap_vld R 0 "Control signal c_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 13.333 machine 64 combinational 0 latency 2 II x}
