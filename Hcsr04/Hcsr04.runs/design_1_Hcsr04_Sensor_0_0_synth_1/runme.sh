...
HD_PWD='C:/FPGA/Hcsr04/Hcsr04.runs/design_1_Hcsr04_Sensor_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Hcsr04_Sensor_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Hcsr04_Sensor_0_0.tcl
