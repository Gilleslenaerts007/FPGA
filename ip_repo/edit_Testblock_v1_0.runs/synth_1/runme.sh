...
HD_PWD='C:/FPGA/ip_repo/edit_Testblock_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Testblock_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Testblock_v1_0.tcl
